...
def signup(request):
    if request.method == 'POST':
        ...
        message = "Hello" + myuser.first_name + "! \n" + "Welcome to Devzery \n Thank you for visiting our website \n We have also sent you a confirmation email, please confirm your email address in order activate the account. \n Thank You" 
        ...
        email_subject = "Confirm your email @ Devzery Login! "
